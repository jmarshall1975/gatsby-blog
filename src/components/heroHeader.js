    ...
    render={data => (
      <div className="hero-header">
        ...
        <div className="primary-content">
          ...
          <p>Naturally, over the years my focus has changed, and today I wear many hats; technical manager, Scrum Master, team coach, but regardless of my focus on any given day, the passion for development that was ignited all that time ago continues to endure.</p>
